...
jjFruits.prototype = {
    ...
    create: function () {
        var fruitsArray = new Array(
            'jjFruit0', 'jjFruit1', 'jjFruit2', 'jjFruit3', 'jjFruit4'
        );
        this.fruitsGroup = game.add.physicsGroup(Phaser.Physics.ARCADE);

        this.fruitsGroup.createMultiple(1, 'jjFruit0', null, false);
        this.fruitsGroup.createMultiple(1, 'jjFruit1', null, false);
        this.fruitsGroup.createMultiple(1, 'jjFruit2', null, false);
        this.fruitsGroup.createMultiple(1, 'jjFruit4', null, false);
        this.fruitsGroup.createMultiple(1, 'jjFruit3', null, false);
        this.fruitsGroup.createMultiple(1, 'jjFruit0', null, false);
        this.fruitsGroup.createMultiple(1, 'jjFruit2', null, false);
        this.fruitsGroup.createMultiple(2, 'jjFruit1', null, false);
        this.fruitsGroup.createMultiple(1, 'jjFruit3', null, false);
        this.fruitsGroup.createMultiple(2, 'jjFruit2', null, false);
        this.fruitsGroup.createMultiple(1, 'jjFruit4', null, false);
        this.fruitsGroup.createMultiple(1, 'jjFruit3', null, false);
        this.fruitsGroup.createMultiple(1, 'jjFruit4', null, false);
        ...
        this.coconutGroup.createMultiple(5, 'jjCoconut', false);
    ...
    render: function () {
        game.debug.text(
            'fruitGroup countLiving : ' + this.fruitsGroup.countLiving(), 32, 400
        );
    }
};
